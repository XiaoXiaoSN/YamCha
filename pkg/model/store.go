...
type Store struct {
	...
	// BranchStores []BranchStore `gorm:"column:ForeignKey:store_group_id" json:"branch_stores,omit"`
}
...
type BranchStore struct {
	...
	StoreGroupID string    `gorm:"column:store_group_id" json:"store_group_id"`
